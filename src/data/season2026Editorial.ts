...
const dossiers: Season2026OwnerEditorial[] = [
  {
    ...
    tone: "sharp",
    thesis: "The league's best quarterback projection and a two-deep premium running-back core give FantasyGPT the cleanest weekly floor. The receiver room is not empty, but it is the one place where an injury or slow start could turn a favorite into merely a good team.",
    titleCase: "Caleb Williams and Joe Burrow keep winning the two-QB math while Bijan Robinson and Christian McCaffrey create weekly separation. One reliable WR2 addition would remove the only obvious soft spot.",
    collapseCase: "The roster is old and expensive at the very top of the running-back room. If McCaffrey misses time and the middle-class receivers stay middle class, the projected 12 wins become vulnerable to normal matchup variance.",
  ...
  },
  {
    ...
    tone: "volatile",
    thesis: "Team Duncan has elite two-quarterback security, CeeDee Lamb, Tee Higgins and Brock Bowers. The projection model loves the total roster, but the schedule turns a No. 3 scoring profile into only a 6–8 median record. Every close week matters.",
  ...
  },
  {
    ...
    tone: "sharp",
    thesis: "Nine-1-1 pairs a top-three running-back room with Puka Nacua and a credible two-QB combination. The 10–4 schedule projection is stronger than the overall No. 4 scoring rank, making Jeff the team most likely to secure a bye without feeling like the preseason favorite.",
  ...
  },
  {
    ...
    tone: "aggressive",
    thesis: "Dak Shots begins with the league's most bankable fantasy quarterback in Josh Allen, plus Patrick Mahomes, James Cook, Saquon Barkley and A.J. Brown. The starting names are better than the No. 5 rank suggests; the model's objection is running-back depth and injury exposure.",
  ...
  },
  {
    ...
    tone: "volatile",
    thesis: "Feels Different This Year has championship-level pillars in Jalen Hurts, Jaxson Dart, Jahmyr Gibbs and Amon-Ra St. Brown. The C+ grade is not about star power; it is about five injury flags, a seventh-ranked tight-end room and too much weekly dependence on the top four.",
  ...
  },
  {
    ...
    tone: "aggressive",
    thesis: "King of January has the league's best tight-end projection, elite two-QB scoring and Ja'Marr Chase. The model still ranks the team seventh because the rest of the receiver room is injured or uncertain and the projected schedule creates only five wins.",
    titleCase: "Lamar Jackson, Drake Maye and Chase can erase ordinary lineup mistakes. If Zay Flowers and Jaylen Waddle are healthy while Tyler Warren hits, the current C grade will look far too pessimistic.",
    collapseCase: "Five injury flags and an eighth-ranked receiver room leave almost no slack. Conner's instinct is to solve every soft spot with another trade, which can turn one weakness into three smaller ones.",
  ...
  },
  {
    ...
    tone: "aggressive",
    thesis: "The defending champion has Jayden Daniels, De'Von Achane, Derrick Henry, Nico Collins and Justin Jefferson. The last-place projection is not a claim that those stars are bad; it is the mathematical cost of an RB-heavy roster with unfinished lineup slots and a seventh-ranked receiver group behind the stars.",
    titleCase: "Samuel's 30–12 three-year record is the best active win rate in the league. If he converts excess running backs into a tight end, defense and healthier receiver depth, the No. 8 preseason model can be embarrassed quickly.",
