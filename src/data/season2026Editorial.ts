...
const dossiers: Season2026OwnerEditorial[] = [
  {
    ...
    tone: "sharp",
    thesis: "The league's best running-back value and a deep, usable weekly lineup give Roy's roster the cleanest floor in the field. The receiver room is not empty, but it is the one place where an injury or slow start could turn a favorite into merely a good team.",
  ...
  },
  {
    ...
    tone: "conservative",
    thesis: "Carl's roster is deep, balanced at the premium pass-catching positions and full of players who can outperform their auction prices. The catch is structural—this is the league's No. 1 receiver room attached to its No. 8 running-back projection.",
  ...
  },
  {
    ...
    tone: "volatile",
    thesis: "Jared's roster has elite quarterback depth, CeeDee Lamb, Tee Higgins and the league's most valuable tight-end room. The lineup-value model is less convinced by the total roster because running back ranks seventh and too much surplus is trapped behind weekly slot limits.",
  ...
  },
  {
    ...
    tone: "sharp",
    thesis: "Jeff's roster pairs Puka Nacua and the league's No. 2 receiver value with a deep running-back rotation and a credible two-QB combination. The overall No. 4 power rank keeps Jeff firmly inside the contender tier.",
  ...
  },
  {
    ...
    tone: "aggressive",
    thesis: "John's roster begins with the league's No. 1 quarterback room in Josh Allen and Patrick Mahomes, plus James Cook, Saquon Barkley and A.J. Brown. The names are stronger than the No. 7 power rank; the model's objection is limited lineup-wide separation beyond the stars and a receiver room that ranks fifth in weekly advantage.",
  ...
  },
  {
    ...
    tone: "volatile",
    thesis: "Edward's roster has championship-level pillars in Jalen Hurts, Jaxson Dart, Jahmyr Gibbs and Amon-Ra St. Brown. The No. 3 power rank and 10–4 median path reflect real starting-lineup value; five injury flags and a seventh-ranked tight-end room keep the range wide.",
